...
sim.model.systemNarrative = "Feedlots buy cattle from their contract breeders with a minimum age of 26 months, "+
    "feed them until a minimum age of 30 months and then sell them to a slaughterhouse. "+
    "On each day, each breeder has a certain number of new born calves. "+
...
sim.model.shortDescription = "The model includes three object types: <i>Cattle</i>, <i>Breeder</i> and <i>Feedlot</i>, as well as three event types: " +
    ...
    "and declining to U(0,500) g when they are older. A <i>Purchase</i> event involves a feedlot, a breeder and a batch of cattle. " +
    "A <i>Sale</i> event involves a feedlot and a batch of cattle. A <i>Restocking</i> event occurs when the cattle stock " +
    "of a feedlot falls below a certain threshold.";
sim.model.license = "CC BY-NC";
sim.model.creator = "Gerd Wagner";
sim.model.created = "2020-03-19";
sim.model.modified = "2020-03-25";
